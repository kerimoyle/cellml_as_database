# Generated by Django 2.2.4 on 2019-10-02 10:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('error_tree', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
                ('child_list', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
                ('math_ml', models.TextField(blank=True, null=True)),
                ('annotations', models.ManyToManyField(blank=True, related_name='used_by_math_objects', to='main.Annotation')),
                ('component', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='maths', to='main.Component')),
